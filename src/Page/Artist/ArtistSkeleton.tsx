...
const ArtistSkeleton: FunctionComponent = () => {
  return (
    <>
      <div className={""}>
        <div className={"flex flex-col gap-2 my-6 w-max p-1 rounded-sm border border-neutral-400 border-dashed"}>
          <div className={"w-20 aspect-square bg-neutral-200"}></div>
